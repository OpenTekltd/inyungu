								  ...
								  <div class="form-group">
									...
									<input type="text" class="form-control" id="telefoni">
									  ...
									  <div class="modal-footer">
										  ...
										  <button type="submit" onclick="kwemeza()" class="btn btn-primary" >Kwemeza</button>
									  </div>
					 </form>
			</div>
		</div>
	    ...
	    function kwemeza(){
			...
			$.ajax({
			 ...
			 success: function(data){	
			   ...
			   alert("mwabashije kwinjiza umuntu muri sisitemu");
			 }
		});
	}
  </script>
