        ...
        <div class="container">
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
                    ...
                    <li class="nav-item"><a class="nav-link link" href="#product_section">IBICURUZWA</a></li>
					<li class="nav-item"><a class="nav-link link" href="#">AMABWIRIZA</a></li>
					<li class="nav-item"><a class="nav-link link" href="#">ABO TURIBO</a></li>
					<li class="nav-item"><a class="nav-link link" href="http://inyungu.com/en/"><img src="../assets/images/uk_flag.png" alt="English"/>   EN</a></li>
					</ul>
        ...
        <div class="mbr-table-cell">
            ...
            <div class="container">
                    ...
                    <div class="mbr-table-md-up">
                        <div class="mbr-table-cell col-md-7 content-size text-xs-center text-md-center">
                            ...
                            <div class="mbr-section-text" style="padding:0px 0px 60px;">
                                <p><strong>Inyungu ni urubuga rugamije guhuza abahinzi n'abaguzi mu Rwanda.</strong></p>
                            </div>  
                            <div class="col-lg-offset-3 col-xs-12 col-lg-4 col-lg-offset-4" style="padding:0px 0px 20px;right:1.5%;">
								<div class="mbr-section-btn">
									<ul id="main-list">
										<li id="display"><a class="btn btn-primary" data-toggle="modal" data-target="#kwemeza" style="background-color: #4CAF50; border-color:#4CAF50;" onmouseover="this.style.backgroundColor = '#067F24';this.style.borderColor = '#067F24';" onmouseout="this.style.backgroundColor = ' #4CAF50';this.style.borderColor = '#067F24';">Injira muri konti yawe!</a></li>
									</ul>
								</div>
                            </div>
                        </div>
				...
				<div id="ibicuruzwa" class="col-lg-offset-4 col-lg-4 col-lg-offset-4" style="top:50px;">
						<h5 class="mbr-section-title" style="padding:0px 0px 30px;text-align:center"><strong>IBICURUZWA </strong></h5>
...
<section id="product_section" style="padding:50px 50px;">
		       <div id="title" style="top:20%;"> 
					 <div id="start_line2"></div>		 
						 <h4 style="text-align:center">IBICURUZWA</h4>
		...
		<div class="container">
				<div class="row" style="padding-top:20px;padding-bottom:30px;">
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;padding:5px 0px;">
							 ...
							 <div>
							   <span><h5>Ikawa<h5></span>
							   <span><a href="inscription.php?product=ikawa" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;padding:5px 0px;">
						      <div><img src='assets/images/pinaple.jpg' style="max-width:23%;" class="product"></div>
							   <div>
							   <span><h5>Inanasi<h5></span>
							   <span><a href="inscription.php?product=inanasi" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;padding:5px 0px;">
						       <div><img src='assets/images/oigno.jpg'  style="max-width:43%;"  class="product"></div>
							   <div>
							   <span><h5>Ibitunguru<h5></span>
							   <span><a href="inscription.php?product=ibitunguru" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
				...
				<div class="row" style="padding-top:0px;padding-bottom:30px;">
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;margin:5px 0px;">
							   ...
							   <div>
							   <span><h5>Amatunda<h5></span>
							   <span><a href="inscription.php?product=amatunda" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;margin:5px 0px;">
						       <div><img src='assets/images/eggs.jpg' style="max-width:50%"  class="product"></div>
							    <div>
							   <span><h5>Amagi<h5></span>
							   <span><a href="inscription.php?product=amagi" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;padding:5px 0px;">
						  	 <div><img src='assets/images/Maize.jpg' style="max-width:43%"  class="product"></div>
							    <div>
							   <span><h5>Ibigori<h5></span>
							   <span><a href="inscription.php?product=ibigori" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
				</div>
									<div class="row" style="padding-top:0px;padding-bottom:30px;">
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;margin:5px 0px;">
							   ...
							   <div>
							   <span><h5>Ibishyimbo<h5></span>
							   <span><a href="inscription.php" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;margin:5px 0px;">
						       <div><img src='assets/images/soya.jpg' style="max-width:53%"  class="product"></div>
							    <div>
							   <span><h5>Soya<h5></span>
							   <span><a href="inscription.php" class="btn btn-primary" style="padding:3px 8px;background-color: #4CAF50; border-color:#4CAF50;">Gutumiza!</a></span>
							 </div>
						  </div>
						  <div class="col-xs-12 col-lg-4" id="product" style="text-align:center;padding:5px 0px;">
           ...
           <!--  <div class="mbr-footer-content col-xs-12 col-md-6 col-lg-3">
            ...
            <div class="col-xs-12 col-md-3" data-form-type="formoid">
                ...
                <div data-form-alert="true">
                    <div hidden="" data-form-alert-success="true">Murakoze kutwandikira.</div>
                </div>
                ...
                <form action="#" method="post" data-form-title="MESSAGE">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="contacts3-2-message">Ubutumwa</label>
                    ...
                    <div><button type="submit" class="btn btn-sm btn-black">Twandikire</button></div>
			 ...
			 <div class="modal-content">
				 <div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-label="close" ><span arial-hidden="true">&times;</span></button>
						 <h4 class="modal-title" id="editLabel">Idirishya ryo kwemeza<h4>
					 </div>
					  <form action="" method="post">
							 <div class="modal-body"> 
								  <div class="form-group">
									 <label style="float:left">Telefoni:</label>
									<input type="text" style="padding:0px 0px;" class="form-control" name="fn" value="">
									 </div>
									<div class="form-group">
									<label style="float:left">Ijambo ry ibanga:</label>
									<input type="password" class="form-control" name="passwrd" value="">
									</div>
							</div>					  
									  <div class="modal-footer">
										  <button type="button" class="btn btn-default" data-dismiss="modal" >close</button>
										  <button type="submit" name="submit" class="btn btn-primary" >Kwemeza</button>
									  </div>
					 </form>
			</div>
		</div>
