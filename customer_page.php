        ...
        <div class="container">
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
                    ...
                    <li class="nav-item"><a class="nav-link link" href="quitter.php">GUSOHOKAMO</a></li></ul>
							 ...
							 <div class="modal-body"> 
								  <div class="form-group">
									...
									<input type="text" class="form-control input-sm" id="last_name_customer" aria-describedby="sizing-addon1">
									 ...
									 <div class="form-group">
									 <label style="float:left">Ikigo ukorera:</label>
									<input type="text" class="form-control input-sm" id="company" aria-describedby="sizing-addon1">
									 </div>
									<div class="form-group">
									<label style="float:left">aho ikigo gikorera:</label>
									<input type="text" class="form-control" id="address">
									</div>
									<div class="form-group">
									<label style="float:left">Imeyili:</label>
