            ...
            <div class="containerr" style="border-color:red;">
                <div class="mbr-section row">
				    ...
				    <!-- <h4>Contact us for custom quote</h4> -->
				      <fieldset>
				      <input placeholder="Eg: 0788010101..." name="telefoni" id="telefoni" type="text" tabindex="1" required />
				    </fieldset>
				    	<?php
				    	if(isset($_POST['submit'])){
					...
					<span style='font-size:0.8em;color:red'>Uzuza neza Telefoni yawe</span><br/>"; 
				         ...
				         ?> 
				    <fieldset>
				      <input placeholder="Name" name="izina" id="izina" type="text" tabindex="1" required />
				    </fieldset>
				    <fieldset>
				      <input placeholder="Other name" name="irindi_zina" id="irindi_zina" type="text" tabindex="1" required />
				    </fieldset>
				    <fieldset>
				      <input placeholder="Company name" name="ikigo_ukorera" id="ikigo_ukorera" type="text" tabindex="1" required >
				    </fieldset>
				    <fieldset>
				      <input placeholder="Company location" name="ikigo_gikorera" id="ikigo_gikorera" type="text" tabindex="1" required >
				    </fieldset> 
				      <fieldset>
				      <input placeholder="Eg: example@gmail.com" name="imeyili" type="email" id="imeyili"  tabindex="1" required />
				    </fieldset>
				    <?php
				    if(isset($_POST['submit'])){
				        if($emailcheck!=1){
