...
<section class="mbr-section mbr-section-hero mbr-section-full header2 mbr-parallax-background mbr-after-navbar" id="header2-0"  style="background-image: url(assets/images/landscape3.jpg);border-color:red">
	...
	<fieldset>
      <select placeholder="Icyo utumizaho" name="select" tabindex="2" style="padding:8.5px 130px;width:100%;border:1px solid;border-color:#C0C0C0;text-align:left;font-size:0.8em" required>
	     <option value="1" selected="selected" disabled="disabled">Our products</option>
         <option id='kawa2' value="inanasi">Pineapple</option>
         <option id='inanasi2' value="ikawa">Coffee</option>
         <option id='inanasi2' value="ibitunguru">Onion</option>
         <option id='inanasi2' value="ibigori">Maize</option>
         <option id='inanasi2' value="amatunda">Passion Fruit</option>
         <option id='inanasi2' value="amagi">Eggs</option>
         <option id='inanasi2' value="ibishyimbo">Beans</option>
         <option id='inanasi2' value="soya">Soy</option>
         <option id='inanasi2' value="ingano">Wheat</option>
      </select>
    </fieldset>
    <script>     
