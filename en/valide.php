        ...
        <div class="container">
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
                    ...
                    <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar"><li class="nav-item"><a class="nav-link link" href="#">RULES</a></li><li class="nav-item"><a class="nav-link link" href="#">WHO WE ARE</a></li></ul>
        ...
        <div class="mbr-table-cell">
            <div class="containerr" style="border-color:red;">
                <div class="mbr-section row" style="width:200%;height:100%;text-align:center;background-color:white;margin-top:80px;margin-left:-200px;padding:18%;border-radius:10px 10px 10px 10px;border:4px solid #4CAF50">
				    ...
				    <p style="font-family:'Courier New', Courier, monospace;font-weight:bold">You have order successfully <?php echo $_SESSION['product']; ?>, Thank you for subscribing to Inyungu. Press where you want to proceed:</p>					
					<div class="mbr-section-btn" style="position:absolute;margin-left:70px;"><a class="btn btn-primary" id="gutumiza" onclick="afficherMessage();" style="background-color: #4CAF50; border-color:#4CAF50;" href='order.php'>ORDER AGAIN</a></div>
		            <div class="mbr-section-btn" style="position:relative;float:right;margin-right:70px;"><a class="btn btn-primary" style="background-color: #4CAF50; border-color:#4CAF50; " href="quitter.php">GO BACK TO THE PREVIOUS PAGE</a></div>
				</div>
            </div>
        </div>
    </div>
