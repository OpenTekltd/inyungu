								 ...
								 <div class="">
										<?php
											$this->beginWidget('zii.widgets.CPortlet', array(
												...
												$link = $row['district']." haraboneka ".$row['productname']." ".$ku." ".$row['quantity']."".$row['mesure']." ,ubwo mwabaza kuri izi numero zikurikira ".$row['telephone'];
...
<div class="span2">
			...
			<div class="well">
			      <a href='http://www.kountable.com'> <img src="images/pub/kountable.png"></a>
			</div> 
			
			<div class="well">
			    <a href='http://www.cyuda.com'>    <img src="images/pub/cyuda.png"></a>
			</div> 

			<div class="well">
                            <a href='http://www.opentek.rw'><img src="images/pub/opentek.jpg"></a>
			</div> 
