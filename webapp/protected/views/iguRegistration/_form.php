...
<?php echo Yii::t('app', 'Ahari aka'); ?> <span class="required" style="color: red;">*</span> <?php echo Yii::t('app', 'musabwe kuhuzuza'); ?>.
                </p>

                <span style="color: red;"><?php echo $form->errorSummary($model); ?></span></td>
        </tr>
        <tr>
            <td>
                <div class="row">
