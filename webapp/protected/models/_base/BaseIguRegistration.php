...
abstract class BaseIguRegistration extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('firstname, lastname, telephone, datedinscription,iddistrict, idumurenge, identite, idcompanytype, nameofcooperative, iduser', 'required','message'=>'<b>{attribute}</b> ntihagomba kubamo ubusa .'),
