...
abstract class BaseUser extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('oldpassword,password_repeat', 'required', 'on'=>'changepaswd'),
                        array('password_repeat','compare','compareAttribute'=>'password','message'=>Yii::t('validation','password don\'t match'),'on'=>'changepaswd'),
		);
	}
